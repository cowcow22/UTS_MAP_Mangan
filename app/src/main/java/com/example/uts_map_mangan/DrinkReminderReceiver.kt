...
class DrinkReminderReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        Log.d("DrinkReminderReceiver", "Notification triggered")
        ...
        val builder = NotificationCompat.Builder(context, "reminder_channel")
            ...
            .setContentText("OMG U forgot to drink!")
            .setPriority(NotificationCompat.PRIORITY_DEFAULT)
            .setStyle(NotificationCompat.DecoratedCustomViewStyle())
            .setCustomContentView(RemoteViews(context.packageName, R.layout.drink_reminder).apply {
